  ...
  return (
    <>
              ...
              <div key={index} className="About_content_layout">
                ...
                <div className="ACL-flex">
                  ...
                  <div style={{ display: "flex", flexDirection: "column" }}>
                    <h2
                      className={date.changedate !== "" && "modify_underline"}
                    >
                      {date.date}
                    </h2>
      ...
      <div className="Speakers">
        {Speakers.length === 0 || !Activate.keynote_speakers ? (
          <div>
            <p
              style={{
                textAlign: "center",
      ...
      <div className="Sponsors">
        {Sponsors.length === 0 || !Activate.sponsors ? (
          <div>
            <p
              style={{
                textAlign: "center",
          ...
          <div className="Sponsors_list">
            {Sponsors.map((sponsor, index) => (
              <div className="Sponsors_item" key={index}>
                {sponsor.link !== "" && sponsor.link !== null ? (
                  <Link
                    className="Sponsors_item_img"
                    to={sponsor.link}
                    target="_blank"
                  >
                  ...
                  <Link className="Sponsors_item_img">
                    <img src={sponsor.logo} alt="" />
                  </Link>
                )}
                {/* <h3>{sponsor.name}</h3> */}
